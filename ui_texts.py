...
STEP_GUIDE_MESSAGES = {
    0: "갤러리 URL을 입력하고 진단을 시작하세요",
    1: "진단 결과를 확인하고 AI가 갤러리 특성을 파악 중입니다",
    2: "게임명과 분석 방향을 확인·수정하고 분석 기간을 설정하세요",
    3: "수집 & AI 분석 진행 중입니다. 잠시 기다려 주세요",
    4: "분석 결과를 검토하고 노션으로 발행하세요",
    5: "발행 완료! 노션 리포트를 확인하세요",
}
...
.tt-wrap .tt-box {
    ...
    min-width:260px; max-width:400px; word-break:keep-all;
}
.tt-wrap .tt-box.tt-wide { max-width:480px; left:0; }
...
.floating-guide {
    ...
    box-shadow:0 2px 10px rgba(59,72,144,0.4);
    max-width:260px; text-align:center; pointer-events:none;
...
{{
  ...
  "topic_confidence": 0~100 숫자,
  "topic_reason": "추정 근거 (1~2문장, 개조식)",
  "suggested_focus": "위 분석 방향 옵션 중 하나의 ID",
